...
1. Вывода информации о всех периметах, площадях и длиннах окружности всех фигур, где это возможно, добавления новой фигуры,
2. Удаления фигуры,
3. Изменения фигуры по ндексу,
4. Сортировки по площади, вывод информации о всех фигурах.  
